...
//  private BCryptPasswordEncoder pe;
  ...
  public void run(String... args) throws Exception {
    ...
    User user1 = new User(null, "llgalvao", "senha123", "Luiz Galvao", "llgalvao24@gmail.com", "08239841414", sdf.parse("24/08/1990"), "19981181356", "profpic1", 1L);
    User user2 = new User(null, "ercilia123", "123senha","Ercilia Silva", "ercilia@gmail.com", "08239841414", sdf.parse("09/07/1992"), "19981181369", "profpic2", 2L);
    User user3 = new User(null, "admin1", "123senha","Admin", "admin@gmail.com", "06239841414", sdf.parse("19/07/1992"), "19981181368", "profpic3", 3L);
    ...
    Address ad3 = new Address("Jean Nassif Mokarzel", "49", "no", "Jd Sta Genebra", "13084-757", "Campinas", "SP", user3);
    user3.setAddress(ad3);
    ...
    Post post6 = new Post(null,"post6", "imageUrl7", "content 7", sdf1.parse("24/08/2019 22:09"), user3);
    Post post7 = new Post(null,"post7", "imageUrl8", "content 7", sdf1.parse("24/08/2019 22:08"), user3);
    ...
    Comment comment4 = new Comment(null, "comment 4", sdf1.parse("30/09/2019 22:25"), user3, post2);
